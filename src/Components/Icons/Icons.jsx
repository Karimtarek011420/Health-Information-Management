...
const Icons = () => {
  ...
  return (
    <div
      className="container-fluid py-4 px-4 text-center justify-content-center "
      id="Partners"
    >
      {english ? (
        <>
        ...
        <>
          <h3 className="header2 p-1 mt-3 text-center fw-bold" style={{ textAlign: 'right', direction: 'rtl' }}>الشركاء</h3>
        </>
      )}
      <div className="row">
        <Swiper
