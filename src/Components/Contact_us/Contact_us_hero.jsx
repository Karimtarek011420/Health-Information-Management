          ...
          <div className='row mx-auto ms-5'>
            <div className="col-md-6 mt-3">  
              <div className="con-us-backg_content p-5 mt-5">
                <p className='con-us-hero-p1 fw-normal lh-base text-white text-md-start text-center mt-5'>Health Information Management</p>
                <h3 className='con-us-hero-h1 me-md-5 pe-md-5 text-md-start text-center fw-bold'>Contact Us</h3>
              </div>
            </div>
          </div>
      </div>
