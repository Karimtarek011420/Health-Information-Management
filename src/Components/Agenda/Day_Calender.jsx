...
function Day_Calender() {
  ...
  const btndisplay = () => {
    return (
      <>
        <button
          onClick={() => handleClick(`btn${btnarr[0] + 1}`)}
          className={
            btn[`btn${btnarr[0] + 1}`]
              ? "btn-day-active px-3 mb-2"
              : "btn-day me-2"
          }
        >
        ...
        <button
          onClick={() => handleClick(`btn${btnarr[1] + 1}`)}
          className={
            btn[`btn${btnarr[1] + 1}`]
              ? "btn-day-active px-3 mb-2"
              : "btn-day me-2"
        ...
        <button
          onClick={() => handleClick(`btn${btnarr[2] + 1}`)}
          className={
            btn[`btn${btnarr[2] + 1}`]
              ? "btn-day-active px-3 mb-2"
              : "btn-day me-2"
  ...
  return (
    <div className="container day_cal_con">
      <div className="btn-nex-prev text-end">
        <button className="btn-prev-dc me-2" onClick={previous}>
          <FaArrowLeft />
        </button>
        <button className="btn-nex-dc" onClick={next}>
          <FaArrowRight />
        </button>
      </div>
        ...
        {btn.btn1 &&
          posts?.map((d) => {
            if (d.date_details === nextSevenDays[0]) {
              return (
                <div
                  className="col-12 col-sm-8 col-md-4 mb-5 mx-auto"
                  key={d.id}
                >
                  <Card item={d} />
                </div>
